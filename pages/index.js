...
function SignInButton() {
  ...
  return (
    <button
      ...
      class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#ffc500] hover:text-black hover:bg-[#ffb500] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ffb500]"
    >
      <span class="absolute left-0 inset-y-0 flex items-center pl-3">
        <svg
          class="h-5 w-5 text-white group-hover:text-black"
